...
def build_candidate(root: Path, timestamp: str, publication_id: str) -> dict:
    ...
    if gf.get("complete_phase2_gate") is not True or gf.get("phase3_authorized") is not False or gf.get("search_authorized") is not False or gf.get("searchable") is not False or inv.get("inventory_summary",{}).get("item_count") != 51: _fail("governance")

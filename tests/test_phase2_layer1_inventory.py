...
def test_authoritative_inventory_has_every_locked_node_and_complete_fields():
 ...
 assert len(value['nodes'])==22 and value['counts']['ACCEPTED']==7 and value['counts']['IMPLEMENTED_UNPROVED']==15
...
def test_ten_strategy_dependency_map_is_narrow_and_frozen():
 ...
 assert set(value['blocking_nodes'])==set(SELECTED) and not value['multi_output_dependencies']

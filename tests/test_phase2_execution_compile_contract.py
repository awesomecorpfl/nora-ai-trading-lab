...
def synthetic(root: Path):
    ...
    manifest={"schema_version":"nora.execution_compile_evidence_manifest_v1","target_identifier":"execution","compile_input_identity":ci["compile_input_identity"],"compiler_output_identity":record["compiler_output_identity"]}
